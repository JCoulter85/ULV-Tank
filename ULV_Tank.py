...
IP_ADDRESS = "IP_ADDRESS_GOES_HERE"  # ip address of host used for video stream
RASPICAM_ON = "raspivid -t 999999 -w 1920 -h 1080 -sa -50 -br 60 -co 20 -fps 24 -b 3000000 -o - | gst-launch-1.0 -e -vvv fdsrc ! h264parse ! rtph264pay pt=96 config-interval=5 ! udpsink host=" + IP_ADDRESS + " port=8160&"
